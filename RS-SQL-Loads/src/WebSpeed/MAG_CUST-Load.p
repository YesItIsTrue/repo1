...
/*------------------------------------------------------------------------
    File        : MAG_CUST-Load.p                                               /* 3dot0 */
    Purpose     : Updates the MAGento CUSTomer ReCorD in the RS database.       /* 3dot0 */

    Description : Production program to read the selected (by date) 
                : Magento extracted .txt file and Update/Create the data 
                : in the MAG_CUST_RCD table in the RS database.
    ...
    <META NAME="LAST_UPDATED" CONTENT="2/Jan/17">
