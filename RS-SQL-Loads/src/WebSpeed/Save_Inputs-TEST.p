...
/*------------------------------------------------------------------------
    ...
    Version 1.4 : 04/Oct/17 by HAROLD LUTTRELL, JR.
                : Changed pathing for Release 12 (CMC structure).
                : Marked by 1dot4
...
{UTIL-set_propath-HHI_TEST-U.i}.                        /* 1dot4 */
...
/** begin 1dot4 **/
ASSIGN 
    olddir  = "C:\apps\RStP\Input-Files\"
    newdir  = "C:\apps\RStP\Processed_Files\"
    errlog  = "C:\Progress\WRK\RStP-save_inputs-U-errlog.txt".
