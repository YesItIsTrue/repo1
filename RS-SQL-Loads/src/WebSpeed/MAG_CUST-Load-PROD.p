...
/*------------------------------------------------------------------------
    File        : MAG_CUST-Load-PROD.p                                          /* 3dot0 */
    Purpose     : Updates the MAGento CUSTomer ReCorD in the CUSTOM database.   /* 3dot0 */
    ...
    Version 3.1 - written by Harold Luttrell, Sr. on 09/Oct/17.  Changed to use
...
/*{UTIL-set_propath-HHI_PROD-U.i}.							/* 3dot1 */*/
