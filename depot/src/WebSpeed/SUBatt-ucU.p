...
/*------------------------------------------------------------------------
    ...
    Revision History:
    -----------------
    1.0 - written by TRAE LUTTRELL on 09/May/16.  Original version.
    1.1 - updated by JACOB LUTTRELL on 22/Feb/17.  Added code to allow
            new ID to be passed in and created.  Marked by 1dot1.
    1.11 - written by DOUG LUTTRELL on 11/Aug/17.  Corrected typos as
            part of the CMC (Version 12) migration.  Marked by 111.
...
DEFINE INPUT PARAMETER i-att_filedesc   LIKE att_files.att_filedesc NO-UNDO.                                /* 111 */
