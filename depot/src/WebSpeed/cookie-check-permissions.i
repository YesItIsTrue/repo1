...
FOR EACH menu_mstr WHERE menu_mstr.menu_exprog CONTAINS i-menu-exprog,
EACH gud_det WHERE gud_det.gud_people_ID = i-empid,
...
IF NOT i-worthiness-verified THEN
    RUN VALUE(SEARCH("cookie-logout.r")) (
        "{1}"
    ).
