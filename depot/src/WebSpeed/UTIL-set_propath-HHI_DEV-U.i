...
/*------------------------------------------------------------------------
    File        : UTIL-set_propath-HHI_DEV-U.i
    Purpose     : 
...
DEFINE VARIABLE DBENV       AS CHARACTER INITIAL "C:\OpenEdge\Databases\DEV" NO-UNDO.
...
ASSIGN 
    ORIGPROPATH = PROPATH
    PROPATH     = "C:\OpenEdge\workspace\depot\rcode\;" + "C:\OpenEdge\workspace\DataHub\rcode\;" + 
