...
DEFINE {1} {2} SHARED TEMP-TABLE XML_TT_tkr_det_Data
    ...
    FIELD TT-tkr_det_TKR_ID                 LIKE TKR_det.TKR_ID      
    FIELD TT-tkr_det_TKR_ID_Seq             LIKE TKR_det.TKR_test_seq 
    
    FIELD TT-tkr_det_TKR_item               LIKE TKR_det.TKR_item
    FIELD TT-tkr_det_TKR_lab_result         LIKE TKR_det.TKR_lab_result
    FIELD TT-tkr_det_TKR_ref_uom            LIKE TKR_det.TKR_ref_uom  
    FIELD TT-tkr_det_TKR_lab_ref            LIKE TKR_det.TKR_lab_ref  
