...
/*------------------------------------------------------------------------
    ...
    Created     : Feb 3, 2015
    Notes       :
    Databases   : General           - now CORE (1dot1)
                  HHI               - now Modules (1dot1)
                  RS.               - now Custom (1dot1)
  ...
  1.1 - written by DOUG LUTTRELL on 12/Oct/17.  Changed pathing to support
            change to single rcode directory structure under TEST or PROD.
            Marked by 1dot1.
...
{UTIL-set_propath-HHI_TEST-U.i}.                                                /* 1dot1 */
