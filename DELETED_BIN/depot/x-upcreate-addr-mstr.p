...
DEFINE INPUT PARAMETER i-ucaddr-id          LIKE general.addr_mstr.addr_id        NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-addr1       LIKE general.addr_mstr.addr_addr1     NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-addr2       LIKE general.addr_mstr.addr_addr2     NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-addr3       LIKE general.addr_mstr.addr_addr3     NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-city        LIKE general.addr_mstr.addr_city      NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-stateprov   LIKE general.addr_mstr.addr_stateprov NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-zip         LIKE general.addr_mstr.addr_zip       NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-country     LIKE general.addr_mstr.addr_country   NO-UNDO.
DEFINE INPUT PARAMETER i-ucaddr-type        LIKE general.addr_mstr.addr_type      NO-UNDO.

DEFINE OUTPUT PARAMETER o-ucaddr-id         LIKE General.addr_mstr.addr_id  NO-UNDO.
