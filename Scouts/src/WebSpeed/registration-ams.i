...
{&OUT}
"                   <a href='cookie-logout-html.r?redirect-location=AMS-landing-R.r' class='w3-bar-item w3-button w3-hover-theme-accent'><i class='fa fa-sign-out dropdown-icon' aria-hidden='true'></i>Logout</a>" SKIP
"               </div>" SKIP
"           </div>" SKIP
"       </div>" SKIP
"   </div>" SKIP
