...
"<form>" SKIP
    ...
    "<DIV class='grid_6'>" SKIP
        ...
        "   <table>" SKIP(1)
        "       <tr>" SKIP
        "           <th colspan=2>State / Province Maintenance</th>" SKIP
        "       </tr>" SKIP(1)
        "       <tr>" SKIP
        ...
        "       </tr>" SKIP(1)
        "       <tr>" SKIP
        "           <td>State / Province ISO</td>" SKIP
        "           <td>" v-state-ISO "</td>" SKIP
        "       </tr>" SKIP(1)
        "       <tr>" SKIP
        "           <td>State / Province Name</td>" SKIP
        "           <td class='{3}' ><input type='text' name='h-state-disp' value='" v-state-disp "' {2} /></td>" SKIP
        "       </tr>" SKIP(1)
        "       <tr>" SKIP
        "           <td>Primary</td>" SKIP
