...
/*------------------------------------------------------------------------
    ...
    Updated     : Thu Jun 02 10:23:00 EDT 2016
    Notes       :
...
DEFINE VARIABLE v-hold-date-col  AS CHARACTER NO-UNDO.
...
DO: 
    ...
    {&OUT}
        ...
        "       <thead>" SKIP
        "           <tr>" SKIP
        "               <th colspan=10>" people_mstr.people_firstname " " people_mstr.people_lastname "'s " CAPS({1}) "</th>" SKIP      /* 1dot2 */
        "           </tr>" SKIP
        "       </thead>"
        "       <tr>" SKIP
        ...
        "           <td>Date Collected</td>" SKIP
        "           <td>Lab Processed<BR>(Lab Completed)</td>" SKIP                              /* 3dot4 */
        "           <td>HHI Processed</td>" SKIP   
        "           <td>HHI Completed</td>" SKIP                                                /* 3dot4 */
        "           <TD>Last Action</TD>" SKIP                                                  /* 1dot2 */
        "           <td>Current Status</td>" SKIP                                               /* 1dot2 */ 
        "       </tr>" SKIP.
    /*        "       <tr>" SKIP.                                                                   /* 1dot2 */ */
...
/*            ASSIGN v-hold-status = trh_hist.trh_action.                                                */
        ...
        {&OUT}
            ...
            "           <td>" v-hold-lab-rcvd "</td>" SKIP
            "           <td>" v-hold-date-comp "</td>" SKIP
            "           <td>" v-hold-status "</td>" SKIP
            "           <td>" tk_mstr.tk_status "</td>" SKIP                                /* 1dot2 */        
            "       </tr>" SKIP
            "   </table>" SKIP
