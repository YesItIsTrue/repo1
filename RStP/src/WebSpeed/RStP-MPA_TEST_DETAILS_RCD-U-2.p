...
DEFINE VARIABLE firstrun AS LOGICAL INITIAL YES  NO-UNDO.     /* change to YES for run number 2 */
...
DEFINE VARIABLE errlog AS CHARACTER 
    INITIAL "C:\PROGRESS\WRK\RStP-MPA_TEST_DETAILS_RCD-U-log-2.txt" NO-UNDO.    /* change -1 to -2 for run number 2. */
