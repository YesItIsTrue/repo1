...
DEFINE VARIABLE firstrun AS LOGICAL INITIAL YES  NO-UNDO.        /* change to YES for second program (RStP-BUTEE-U-4.p) */
...
DEFINE VARIABLE errlog AS CHARACTER 
    INITIAL "C:\PROGRESS\WRK\RStP-BUTEE-U-log-4.txt" NO-UNDO.   /* change to 4 for second program (RStP-BUTEE-U-4.p) */
