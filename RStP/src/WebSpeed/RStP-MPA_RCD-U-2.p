...
DEFINE VARIABLE firstrun AS LOGICAL INITIAL YES NO-UNDO.                         /* change to YES for 2nd program */
...
DEFINE VARIABLE errlog AS CHARACTER 
    INITIAL "C:\PROGRESS\WRK\RStP-MPA_RCD-U-log-2.txt" NO-UNDO.             /* change to 2 for second program */                 
