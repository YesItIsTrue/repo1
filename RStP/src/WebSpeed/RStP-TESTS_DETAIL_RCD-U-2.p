...
DEFINE VARIABLE firstrun         AS LOGICAL   INITIAL YES NO-UNDO.                   /* change to YES for the second program */
...
DEFINE VARIABLE errlog AS CHARACTER 
    INITIAL "C:\PROGRESS\WRK\RStP-TESTS_DETAIL_RCD-U-log-2.txt" NO-UNDO.  /* 1dot1 */ /* change to 2 for the second program */
