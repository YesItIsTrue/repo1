...
DEFINE VARIABLE firstrun AS LOGICAL INITIAL NO NO-UNDO.                         /* change to YES for very first run only */
...
DEFINE VARIABLE errlog AS CHARACTER 
    INITIAL "C:\PROGRESS\WRK\RStP-PATIENT_FILES-attfiles-log-1.txt" NO-UNDO.            /* change this to be a filename specific to your program */
