...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="UTM" userelativepaths="yes" externalpreview="no" url="U150624-2073-1.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="SS_MPA2.xml" destSchemaRoot="root" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="U150624-2073-1.xml" srcSchemaRoot="root" AssociatedInstance="" loaderFunction="document" loaderFunctionUsesURI="no"/>
		</MapperInfo>
		<MapperBlockPosition>
			<template match="/">
				...
				<block path="root/TK_test_seq/tk_mstr/TK_ID/xsl:value-of" x="390" y="414"/>
